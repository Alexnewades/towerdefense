...
function handleGameGrid() {
    for (let i = 0; i < gameGrip.length; i++) {
        gameGrip[i].draw()
    }
}
// projectiles
const bullet = new Image();
bullet.src = 'spritesheet/bullet1.png'
class Projectile {
    constructor(x, y) {
        this.x = x;
        this.y = y;
...
defender1.src = 'spritesheet/defender1.png'
const defender2 = new Image();
defender2.src = 'spritesheet/defender2.png'
class Defender {
    constructor(x, y) {
        this.x = x;
        this.y = y;
...
boss1.src = 'spritesheet/boss1.png'
...
class Boss {
    ...
    draw() {
        ...
        ctx.drawImage(boss1, this.frameX * this.spriteWidth, 0, this.spriteWidth, this.spriteHeight, this.x, this.y, this.width, this.height);
    }
}
...
function HandleBoss() {
    for (let i = 0; i < enemies.length;) {
        ...
        if (boss.health <= 0) {
            let gainedResources = boss.maxHealth / 10;
            floatingMessages.push(new floatingMessage('+' + gainedResources, boss.x, boss.y, 30, 'black'));
...
enemy1.src = 'spritesheet/enemy1.png';
enemyTypes.push(enemy1);
const enemy2 = new Image();
enemy2.src = 'spritesheet/enemy2.png';
enemyTypes.push(enemy2);
const enemy3 = new Image();
enemy3.src = 'spritesheet/enemy3.png';
...
crystal.src = 'spritesheet/crystal1.png';
...
class Resource {
    ...
    draw() {
        ...
        ctx.drawImage(crystal, this.frameX * this.spriteWidth, 0, this.spriteWidth, this.spriteHeight, this.x, this.y, this.width, this.height);
    }
}
